                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="<?= site_url('users/sendmessage') ?>" method="POST" class="form-horizontal form-label-left input_mask">
                                    <p>Chat.</p>
                                    <div class="col-sm">
                                        <label for="to_admin">To</label>
                                        <input type="password" class="form-control form-control-user" name="to_admin" placeholder="Administrator" disabled>
                                    </div>
                                    <br>
                                    <div class="col-sm">
