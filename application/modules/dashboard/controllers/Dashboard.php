...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        $data	= [
            ...
            'donuser'   => $this->Dashboard_model->viewDonatur()->result_array(),
            'anakAsuh'	=> $this->Dashboard_model->anakAsuh(),
            'usersl'	=> $this->Dashboard_model->view()->result_array(),
            'donasi'    => $this->Dashboard_model->viewDonasi()->result_array(),
    ...
    public function addannouncement($id = 0)
    {
        if ($id != 0) {
            ...
            if ($this->Dashboard_model->update_announcement($id, $data)) {
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Pengunguman Berhasil di Update <br>Judul : ' . $data['judul'] . '</div>');
            };
            ...
            if ($this->Dashboard_model->insert_announcent($input)) {
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data Pengunguman Berhasil Ditambahkan</div>');
            }
            redirect('dashboard/announcement');
        }
    }
    ...
    public function deleteAnnouncement($id)
    {
        if ($this->Dashboard_model->delete_announcement($id)) {
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congrulation your announcement data has been deleted</div>');
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Error To delete your announcement data</div>');
        }
        redirect('dashboard/announcement');
    }
    ...
    public function role()
    {
        $data	= [
            ...
            'usersl'		=> $this->Dashboard_model->view()->result_array(),
            'agama'			=> $this->Login_model->viewagama()->result_array(),
            'roleuser'		=> $this->Dashboard_model->viewRole()->result_array(),
            'Role'	        => true,
            'breadcumb'	    => "Role",
            'view'		    => "v_Role"
        ];
    ...
    {
        $input = [
            'keterangan'      => htmlentities($this->input->post('name'))
        ];

        if ($this->Dashboard_model->insertRole($input)) {
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Success to Insert Role Data Name = ['.$input['keterangan'].'] Success !!</div>');
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Error</div>');
        }
    ...
    public function editRole()
    {
        ...
        if ($this->Dashboard_model->update_role($input)) {
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Success to Update Role Data Name = ['.$input['keterangan'].'] Success !!</div>');
        } else {
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Error</div>');
        }
        redirect('dashboard/role', 'refresh');
    ...
    {
        if ($this->Dashboard_model->delete_Role($id)) {
    ...
    public function anakAsuh()
    {
        $data	= [
            ...
            'allmessages'	=> $this->Dashboard_model->allMessages(),
            'usersl'		=> $this->Dashboard_model->view()->result_array(),
            'anak'          => $this->Dashboard_model->viewAnak()->result_array(),
            'AnakAsuh'      => true,
            'breadcumb'	    => "Anak asuh",
            'view'		    => "v_anakAsuh"
        ];
    ...
    public function donasi()
    {
        $data	= [
            ...
            'allmessages'	=> $this->Dashboard_model->allMessages(),
            'usersl'		=> $this->Dashboard_model->view()->result_array(),
            'donasi'        => $this->Dashboard_model->viewdon()->result_array(),
            'donasidon'     => true,
            'breadcumb'	    => "Donasi Dari Donatur",
            'view'		    => "v_donasi"
        ];
        $this->load->view("index", $data);
    }

    public function donVerifikasi($id)
    {
        // Ambil status donasi donatur
        $data['status'] = $this->Dashboard_model->viewStatDon($id)->result_array();
        ...
        // Give variabel update
        $update = [
            'status' => $setstat
        ];

        if ($this->Dashboard_model->update_statDon($id, $update)) {
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Data User Berhasil di Update <br>Username : ' . $data['username'] . '</div>');
        }
        redirect('dashboard/donasi');
    }
}
