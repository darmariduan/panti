...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Anak Asuh</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $anakAsuh; ?></div>
                                </div>
                                <div class="col-auto">
                                    <i class="fas fa-users fa-2x text-gray-300"></i>
                                </div>
                    ...
                    <div class="card border-left-info shadow h-100 py-2">
                        <a href="dashboard/donasi">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Donasi</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                $totaldon = 0;
                                                foreach ($donasi as $donasi) {
                                                    $totaldon += $donasi['nominal'];
                                                };
                                                echo 'Rp. ' .number_format($totaldon, 0, ',', '.');
                                            ;?>
                                        </div>
                                    </div>
                                    <div class="col-auto">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="x_content">
                                <button data-toggle="modal" data-target="#add" class="btn btn-success"><i class="fa fa-upload"></i> &nbsp; Upload Tanda Terima</button>
                                <br>
                                <br>
        ...
        <!-- Adding Bukti Tanda Terima modal -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel2">Upload Files Buki Tanda Terima </h4>
                    </div>
                    <div class="modal-body form-horizontal form-label-left">
                        <div class="form-group">
                            <label for="password" class="control-label" style="text-align: right">File Name </label>
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input required type="text" class="form-control" name="file_name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="password" class="control-label" style="text-align: right">Give to </label>
                            <select class="form-control " name="to_usersadmin" id="to_usersadmin" required>
                                <option value="1">No Selected</option>
                                <?php foreach ($donuser as $row) : ?>
                                    <option value="<?php echo $row['id']; ?>"><?php echo $row['nama_admin']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="password" class="control-label" style="text-align: right">File </label>
                            <div class="col-md-8 col-sm-8 col-xs-12">
