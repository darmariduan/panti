...
<script src="<?= base_url('frontend');?>/assets/vendor/moment/min/moment.min.js"></script>
<script src="<?= base_url('frontend');?>/assets/vendor/bootstrap-datetimepicker/src/js/bootstrap-datetimepicker.js"></script>
...
<script src="<?= base_url('frontend');?>/assets/vendor/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js"></script>
