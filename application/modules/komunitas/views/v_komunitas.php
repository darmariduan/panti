			...
			<div class="col-md-6 pl-md-5">
				<div class="row justify-content-start pt-3 pb-3">
					<div class="col-md-12 heading-section ftco-animate">
						<span class="subheading">Panti Asuhan masa kini</span>
						<h2 class="mb-4"><?= $lain->heading ?></h2>
						<p><?= $lain->text_heading ?></p>
						<div class="tabulation-2 mt-4">
							<ul class="nav nav-pills nav-fill d-md-flex d-block">
								<li class="nav-item  px-lg-1 mb-md-0 mb-2">
								</li>
							</ul>
						...
						<div class="years d-flex mt-4 mt-md-5">
							<h4>
								<span class="number mr-2" data-number="<?= selisihTahun('now', $komunitas->tgl_berdiri) ?>">0</span>
								<span>Tahun hadir di Bandung, Jawa Barat</span>
							</h4>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="row justify-content-center mb-5">
			<div class="col-md-10 text-center heading-section ftco-animate">
				<span class="subheading">EXPLORE Panti Asuhan </span>
				<h2 class="mb-4">Beragam Aktivitas Seru Anak Panti</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
