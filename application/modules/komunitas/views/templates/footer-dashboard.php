    ...
    <div class="row mb-9">
      <div class="col-md">
        <div class="ftco-footer-widget mb-8">
          <h1 class="logo"><a href="#">Nurul Ilmi Derwati <span>Panti Asuhan Anak</span></a></h1>
          <p> Berada di pinggiran kota Bandung berpegang teguh pada nilai nilai kemanusiaan, kebhinekaan, dan nilai Ahlussunnah wal Jamaah. Saat ini panti asuhan ini menampung dan mendidik anak anak yatim piatu dan dhuafa dari berbagai macam suku seperti Sunda, Jawa, Batak, dan Flores. Mereka berjumlah 65 anak</p>
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <div class="block-23 mb-3">
            <ul>
              <li><span class="icon icon-map-marker"></span><span class="text"><?= $komunitas->alamat . '<br>' . $this->GetKomunitas_model->showProvinsi($komunitas->provinsi) . ' - ' . $this->GetKomunitas_model->showKabupaten($komunitas->kabupaten) . ', ' . $this->GetKomunitas_model->showKecamatan($komunitas->kecamatan) . ', ' . $this->GetKomunitas_model->showDesa($komunitas->desa) ?>.</span></li>
      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          <h2 class="ftco-heading-2">Layanan Informasi Pendaftaran Siswa Baru 24 jam</h2>
