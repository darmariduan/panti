                            ...
                            <div class="x_content">
                                <div>
                                    ...
                                    <div class="x_panel">
                                        <div class="x_content">
                                            <div class="row">
                                                <form action="<?= base_url('addnews/publishedit/'.$berita[0]['id_berita']); ?>" method="post" enctype="multipart/form-data">
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <div class="panel-body">
                                                                <div class="form-group">
                                                                    <label>Title</label>
                                                                    <input type="text" name="title" class="form-control" value="<?= $berita[0]['judul'];?>">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label">Contents</label>
                                                                    <textarea name="contents" id="summernote"><?= $berita[0]['deskripsi'];?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
